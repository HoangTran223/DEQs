...
def add_deq_args(parser: argparse.ArgumentParser):
    group = parser.add_argument_group('deq', 'DEQ model configurations')
    group.add_argument("--n-deq-blocks", type=int, default=2)
    group.add_argument("--deq-f-max-iter", type=int, default=30)
    group.add_argument("--deq-b-max-iter", type=int, default=30)
    group.add_argument("--deq-f-tol", type=float, default=1e-3)
    group.add_argument("--deq-b-tol", type=float, default=1e-6)
    group.add_argument("--deq-n-states", type=int, default=1)
    group.add_argument("--deq-gamma", type=float, default=0.8)
    group.add_argument("--deq-solver", type=str, default="fixed_point_iter")
    group.add_argument("--deq-norm-type", type=str, default="weight_norm")
    group.add_argument("--deq-init-pretrained", action="store_true")
    return parser
